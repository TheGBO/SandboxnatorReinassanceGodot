...
const DownloadDialogScene = preload("res://_ThirdParty/addons/input_helper/views/download_dialog.tscn")
...
func _enter_tree():
	add_autoload_singleton("InputHelper", "res://_ThirdParty/addons/input_helper/input_helper.gd")
