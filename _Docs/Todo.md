...
- [ ] - **Implement inventory system:**
  - [x] - **Structure:** 32-slot list of item stacks (Data: `ItemID`, `Amount`). Max stack: 96 (stackable), 1 (non-stackable).
...
- [ ] - Fix naming discrepancy of "Placing" and "Placeable".
- [x] - Fix player instance race condition on join XXXXXX \*seems to be fixed, needs further stress testing.
...
- [ ] - Build a data-driven system or an editor tool to allow for easier creation of PlacingItems, currently, you need to define three different assets in order to add a single new building item to the game:
